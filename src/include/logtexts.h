...
#define SHARKCALCULATOR_LOGTEXTS_H
    #define L0001 ": Exit program.[I_0000]"
    #define L0002 ": Unknow error.[E_-1]"
    #define L0003 ": Result-pool reset.[W_3001]"
    #define L0004 ": Start program.[I_0001]"
    #define L0005 ": File not found.[E_4040]"
    #define L0006 ": Cannot access result-pool term, Because deta-term nothingness or no read permission.[E_3002]"
    #define L0007 ": File read failed.[E_4041]"
